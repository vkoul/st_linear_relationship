...
If we use a **linear regression** to find out this relationship, the mathematical formulae will mimick the line equation of the form $y= mx+c$, where $m$ is the **coefficient** and $c$ is a **constant** value.
